...
public class DwdTradePayDetailSuc {
    public static void main(String[] args) throws Exception {
        ...
        tableEnv.executeSql("" +
                ...
                ")" + KafkaUtil.getKafkaDDL("linux1:9092","dwd_trade_order_detail", "dwd_trade_pay_detail_suc"));
        ...
        tableEnv.executeSql("create table topic_db(" +
                ...
                "`ts` string\n" +
                ")" + KafkaUtil.getKafkaDDL("linux1:9092","topic_db", "dwd_trade_pay_detail_suc"));
        ...
        tableEnv.executeSql("create table dwd_trade_pay_detail_suc(\n" +
                ...
                ")" + KafkaUtil.getUpsertKafkaDDL("linux1:9092","dwd_trade_pay_detail_suc"));
